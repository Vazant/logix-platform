package com.vazant.currency.infrastructure.kafka;
...
import com.vazant.currency.infrastructure.kafka.dto.CurrencyConversionRequest;
import com.vazant.currency.infrastructure.kafka.dto.CurrencyConversionResponse;
...
public class CurrencyConversionListener {
  ...
  public void handleConversionRequest(
    ...
    CurrencyConversionResponse response = new CurrencyConversionResponse(null, result);
